...
industriesDict = {
    ...
    # "1001002000": "電信及通訊相關業", DONE
    # "1001002001": "電信相關業",
    # "1001002003": "通訊機械器材相關業",
    # "1001002004": "其他電信及通訊相關業",
    # "1001003000": "電腦及消費性電子製造業", DONE
...
def search_industries():
    try:
        url = "https://www.104.com.tw/jobs/search/ajax/function-tree/industry"
        response = requests.get(url, headers=headers)

        if response.status_code == 200:
            # data = response.json()
            # industriesDict = data['data']
            industriesList = industriesDict.keys()
            for industry in industriesList:
                save_to_excel({"indcat": industry, "order": 4}, industriesDict[industry])
                print(f"Industry: {industry}, Name: {industriesDict[industry]}")
...
def save_to_excel(query, fileName):
    ...
    file_name = f"104_{fileName}_{file_created_time}.xlsx"
